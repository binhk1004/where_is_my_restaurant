...
import com.binhk.model.RestautantVO;
	...
	public class UpdateReview extends HttpServlet {
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			String url = "WEB-INF/views/updatereview.jsp";
			...
			try {
				...
				RestautantVO pvo = new Restaurant().anotherread(address,num, getmembernum);
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			new Restaurant().update(pvo, address, num, getmembernum);
			
			response.sendRedirect("/ReadReview?address="+ URLEncoder.encode(address, "UTF-8")+"&membernum="+getmembernum);
		}
