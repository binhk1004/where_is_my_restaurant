        	...
        	let store_address = '<%=request.getParameter("address")%>'
                ...
                if(input_number == null){
                    alert('수정할 리뷰를 선택해주세요.')
	       		  ...
	       		  let url = "/AdminUpdate?membernum="+checkLogin+'&num='+input_number
	       	      let name = "팝업";
                ...
                if(input_number == null){
                    ...
                    {
                        location.href='AdminDelete?num='+input_number+'&membernum='+checkLogin;
                    }
                }
	       	  }
